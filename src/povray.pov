...
// HERE
text{ttf "/usr/share/fonts/truetype/liberation/LiberationMono-Italic.ttf",  "z",  0.01,  0
     texture{TexRed} 
     scale 1.2 translate <AxisLX+0.05,0.7,-0.12>}
text{ttf "/usr/share/fonts/truetype/liberation/LiberationMono-Italic.ttf",  "y",  0.01,  0  
     texture{TexRed} 
     scale 1.2 translate <-0.85,AxisLY+0.50,-0.05>}
text{ttf "/usr/share/fonts/truetype/liberation/LiberationMono-Italic.ttf",  "x",  0.01,  0
     texture{TexRed} 
...
#declare F=function{
pattern{
density_file df3 "density_version5.df3"
...
text
{
 ttf "/usr/share/fonts/truetype/liberation/LiberationMono-Italic.ttf", "2 fm",  0.01,  0
 pigment{color rgb <1,1,1>}
 rotate x*90
 rotate y*-90
 scale 0.8
