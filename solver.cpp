 ...
 * @param zVals Vector of coordinates on the \a z axis
 */
arma::mat Solver::version1(arma::Col<double> rVals, arma::Col<double> zVals) {
    arma::mat result = arma::zeros(rVals.size(), zVals.size()); // number of points on r- and z- axes
    // a and b are used to convert
    uint a = 0;
    uint b = 0;
 ...
 * @param zVals Vector of coordinates on the \a z axis
 */
arma::mat Solver::version2(arma::Col<double> rVals, arma::Col<double> zVals) {
    arma::mat result = arma::zeros(rVals.size(), zVals.size()); // number of points on r- and z- axes
    // a and b are used to convert
    uint a = 0;
    uint b = 0;
 ...
 * @param zVals Vector of coordinates on the \a z axis
 */
arma::mat Solver::version3(arma::Col<double> rVals, arma::Col<double> zVals) {
    arma::mat result = arma::zeros(rVals.size(), zVals.size()); // number of points on r- and z- axes
    // a and b are used to convert
    uint a = 0;
    uint b = 0;
 ...
 * @param zVals Vector of coordinates on the \a z axis
 */
arma::mat Solver::version4(arma::Col<double> rVals, arma::Col<double> zVals) {
    arma::mat result = arma::zeros(rVals.size(), zVals.size()); // number of points on r- and z- axes
    // a and b are used to convert
    uint a = 0;
    uint b = 0;
 ...
 * @param zVals Vector of coordinates on the \a z axis
 */
arma::mat Solver::version5(arma::Col<double> rVals, arma::Col<double> zVals) {
    arma::mat result = arma::zeros(rVals.size(), zVals.size()); // number of points on r- and z- axes
    // a and b are used to convert
    uint a = 0;
    uint b = 0;
